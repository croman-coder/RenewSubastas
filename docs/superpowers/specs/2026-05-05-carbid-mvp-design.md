...
**Estrategia**: *Committed* en superficies de marca (login, landing, hero), *Restrained* en producto interno (dashboards, formularios). Theme por defecto `light`; dark disponible. Anti-reflexes evitados: no "auction red", no automotive navy/silver, no colores bandera Paraguay, no neon-on-black, no SaaS-teal.
